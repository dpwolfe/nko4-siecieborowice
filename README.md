...
~~~sh
# getting the code
git clone git@github.com:nko4/siecieborowice.git && cd ./siecieborowice/

# developing
npm install
npm start

# deploying (to http://siecieborowice.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@siecieborowice.2013.nodeknockout.com
ssh root@siecieborowice.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@siecieborowice.2013.nodeknockout.com
ssh -i ./id_deploy root@siecieborowice.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/siecieborowice" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
